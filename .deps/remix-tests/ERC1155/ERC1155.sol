...
import "../bayc/Address.sol";
import "../bayc/String.sol";
...
contract ERC1155 is IERC165, IERC1155, IERC1155MetadataURI {
     ...
     * 要求:
     * - to 不能是0地址.
     * - from擁有足夠的持倉量，且調用者擁有授權
     * - 如果 to 是智能合約, 他必須支持 IERC1155Receiver-onERC1155Received.
     */
    ...
    /**
     * 返回ERC1155的id種類代幣的uri，存儲metadata，類似ERC721的tokenURI.
     */
